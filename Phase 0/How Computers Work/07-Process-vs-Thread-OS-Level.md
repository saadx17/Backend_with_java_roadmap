...
## 6. Concurrency vs Parallelism (quick clarity)
...
Java exposes OS threads directly (until virtual threads — see below):
...
- Understanding **shared heap** explains *why* you need `synchronized`, `volatile`, `ConcurrentHashMap`, atomics, etc.
...
*Previous topic: **How programs are loaded into memory**.*
*Next topic in roadmap: **Virtual memory and paging**.*
